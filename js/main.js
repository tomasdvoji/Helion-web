...
if (form) {
  ...
  syncServis();
  /* ==== HELION: odesilani pres endpoint ====
     Obsluha odeslání tu bývala a skládala mailto:. Odeslání teď řeší
     form.js, který posílá poptávku na endpoint a hlásí konverzi až po
     potvrzeném uložení. Dvě obsluhy na jednom formuláři by znamenaly,
     že se poptávka odešle A zároveň otevře poštovní klient.

     Kontrola souhlasu se servisním ceníkem se přesunula do form.js —
     musí proběhnout před odesláním a na pořadí posluchačů se spolehnout
     nedá. Přepínání ceníku a předvyplnění podle ?typ= zůstávají výš. */
